...
class block_user_activity_graphs extends block_base
{
    ...
    {
        // Set the block title from configuration or default to plugin name
        // $this->title = isset($this->config->title) && !empty($this->config->title)
        //     ? $this->config->title
        //     : get_string('pluginname', 'block_user_activity_graphs');
        // $this->title = '';
